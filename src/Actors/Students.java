...
public class Students extends Universal {
    ...
    public Students(int ID, String name, String lastname, String groupa, String department, String discipline, byte mark, String nameTeacher, ArrayList<String> arrayList) {
    ...
    public Students(){
        this(0,"john","Marget","3G","OOP","121", (byte) 5,"Maslow",new ArrayList<>());
    }
